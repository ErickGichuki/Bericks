...
export default function Home() {
  return (
    <div className="min-h-screen pt-5">
      <div className="h-100 mx-auto max-w-8xl py-6 px-6 flex flex-col md:flex-row justify-between items-center">
        <div className="mt-8 md:mr-8">
          <h1 className="font-bold text-2xl mb-4">
            Exclusive Fashion, Designs and
            <br />
            Personalized Style consulting
          </h1>
          <p className="text-md mb-6">
            Discover innovative fashion that brings elegance, sophistication,{" "}
            <br />
            and uniqueness to your wandrobe.
            <br /> Our team is dedicated to making you look your best.
          </p>
          <div className="w-full space-x-0 space-y-4 md:space-y-0 md:space-x-4 flex flex-col md:flex-row">
            <button className="md:mb-0 font-semibold py-2 px-4 border rounded-lg mb-4 hover:text-blue-800 hover:border-purple-700">
              Talk to us
            </button>
      ...
      <div className="flex flex-col md:flex-row lg:flex-row bg-violet-800 py-6 text-white">
        <div className="items-center justify-center">
          ...
          <p className="text-center py-6">
            We have successfully delivered & showcasing our community to
      ...
      <div className="md:py-8 md:px-20">
        <div className="text-center">
          <h3 className="text-md text-violet-700">Our Features</h3>
          <p className="text-2xl py-2">
            Amazing <span className="text-violet-700">Features</span>
          </p>
          <p className="py-4">
            We offer you quality services tailored to ensure you march along
            well.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 p-5">
          <div className="space-y-2">
            ...
            <p className="items-center">
              Our garment construction services are designed to create
              high-quality, bespoke clothing. <br />
              We esnure each piece meets our exacting standards of craftmanship
              and fit.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p>
              We focus on creating stylish and comfortable footwear.
              <br /> We try our best to deliver unique designs that blend
          ...
          <div className="space-y-2">
            ...
            <p>
              At Bericks we undertand that perfect garment fits and therefore
              our expert team uses advanced techniques to create accurate
              patterns tailored to your specifications.
            </p>
          </div>
          <div className="space-y-2">
            <div className="flex flex-row space-x-2 items-center">
            ...
            <p>
              Our printing services offer high-quality prints for textiles and
              apparel. We utilize state-of-the-art technology to produce
              vibrant, long-lasting prints that bring your designs to life.
            </p>
          </div>
          <div className="space-y-2">
            <div className="flex flex-row space-x-2 items-center">
            ...
            <p>
              We offer creative textile design services to develop unique
              fabrics and patterns. Our team of designers works with premium
              materials to deliver exceptional textile designs.
            </p>
          </div>
          <div className="space-y-2">
            <div className="flex flex-row space-x-2 items-center">
            ...
            <p>
              Our embroidery services add a touch of elegance and
              personalization to your garments. We use high-quality threads and
              techniques to create intricate and beautiful embroidery designs.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="md:w-1/2">
            <div className="space-y-2">
              ...
              <p className="text-xl font-bold">
                Designs built by{" "}
                <span className="text-purple-800">professionals</span>
              </p>
            </div>
            <div className="items-center">
              <p className="w-3/4">
                We aim at bringing elegant solution to the market. We have
                proofessionals who are doing a great work here with us.
              </p>
            </div>
            <div className="flex flex-row py-4">
              <div className="md:w-1/2 space-y-2">
                ...
                <p className="w">
                  ...
                  country just to deliver bespoke products.
                </p>
              </div>
              <div className="md:w-1/2 space-y-2">
                <div className="flex flex-row items-center space-x-3">
                ...
                <p className="w-3/4">
                  We promise to offer the best rate we can - at par with the
                  industry standard.
                </p>
              </div>
            </div>
