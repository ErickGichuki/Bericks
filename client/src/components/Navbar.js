...
function Navbar() {
  ...
  return (
    <>
      <nav className="fixed z-50 top-0 left-0 w-full p-6 bg-white border-b">
        ...
        <div className={`md:hidden ${open ? "block" : "hidden"} mt-4`}>
          <div className="space-y-4">
            ...
            <Link href="/testimonials" className="block hover:text-purple-600">
              Testimonials
            </Link>
            <Link href="/login" className="block hover:text-purple-600">
              Login
            </Link>
